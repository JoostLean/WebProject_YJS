					...
					<div class="mb-login-template">
						<div class="mb-login-template1">
							<div class="mb-login-item-box">
								<form action="" id="mb_form_login" method="POST"
									...
									<div class="user-login-input-wrap">
										<div class="mb-login-id-wrap">
											...
											<input name="user_id" id="user_id" class="user-login-input"
												type="text" placeholder="ID" value="test"></label>
										</div>
										<div class="mb-login-passwd-wrap">
											<label for="user_password">
												...
												type="password" maxlength="30" value="test"></label>
										</div>
									</div>
										...
										<div class="mb-social mb-social-login">
											...
											<div class="mb-social-btn-box">
												<a style="margin-right: 10px;"
													...
													<img decoding="async"
													src="https://demo.mangboard.com/wp-content/plugins/mangboard/plugins/sociallogin/images/icon_kakao.png"
													...
													<img decoding="async"
													src="https://demo.mangboard.com/wp-content/plugins/mangboard/plugins/sociallogin/images/icon_naver.png"
													style="max-width: 33px; max-height: 33px;"
													title="Login with Naver" alt="Login with Naver"
													class="radius-4"></a><a class="margin-right-10"
													onclick="requestSocialLoginData('google')">
													<img decoding="async"
													src="https://demo.mangboard.com/wp-content/plugins/mangboard/plugins/sociallogin/images/icon_google.png"
													style="max-width: 33px; max-height: 33px;"
													title="Login with Google Plus" alt="Login with Google Plus"
													class="radius-4"></a><a class="margin-right-10"
													onclick="requestSocialLoginData('facebook')">
													<img decoding="async"
													src="https://demo.mangboard.com/wp-content/plugins/mangboard/plugins/sociallogin/images/icon_facebook.png"
													style="max-width: 33px; max-height: 33px;"
													title="Login with Facebook" alt="Login with Facebook"
													class="radius-4"></a><a class="margin-right-10"
													onclick="requestSocialLoginData('instagram')">
													<img decoding="async"
													src="https://demo.mangboard.com/wp-content/plugins/mangboard/plugins/sociallogin/images/icon_instagram.png"
													style="max-width: 33px; max-height: 33px;"
													title="Login with Twitter" alt="Login with instagram"
													class="radius-4"></a><a
													onclick="requestSocialLoginData('twitter')">
													<img decoding="async"
													src="https://demo.mangboard.com/wp-content/plugins/mangboard/plugins/sociallogin/images/icon_twitter.png"
													style="max-width: 33px; max-height: 33px;"
